...
import com.pravin.lede.gl.myapplication.customView.SnakeGameCustomView;
...
public class MainActivity extends AppCompatActivity {
    ...
    SnakeGameCustomView snakeGameCustomView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        snakeGameCustomView = findViewById(R.id.snakeOne);
